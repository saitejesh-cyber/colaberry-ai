...
export default function NewsletterSignup({
  ...
  return (
    <div className={compact ? "rounded-lg border border-slate-200/80 bg-white/80 p-3 dark:border-slate-700/80 dark:bg-slate-900/70" : ""}>
      ...
      <form onSubmit={onSubmit} className={compact ? "mt-3 flex flex-col gap-2" : "mt-3 flex flex-col gap-2"}>
        ...
        <label htmlFor={consentId} className="mt-1 flex items-start gap-2 cursor-pointer">
          <input
            ...
            required
            aria-required="true"
            className="mt-0.5 h-4 w-4 shrink-0 rounded border-slate-300 text-brand-purple-600 focus:ring-2 focus:ring-brand-purple-600/25 dark:border-slate-600"
          />
